...
public class jyotiba extends AppCompatActivity {
    ...
    QueAndAnsAdapter[] questionbank=new QueAndAnsAdapter[]{
            ...
            new QueAndAnsAdapter(R.string.Question_22,false),
            new QueAndAnsAdapter(R.string.Question_23,true),
            new QueAndAnsAdapter(R.string.Question_24,false),
            new QueAndAnsAdapter(R.string.Question_25,false),
            new QueAndAnsAdapter(R.string.Question_26,true),
            new QueAndAnsAdapter(R.string.Question_27,false),
            new QueAndAnsAdapter(R.string.Question_28,true),
            new QueAndAnsAdapter(R.string.Question_29,false),
            new QueAndAnsAdapter(R.string.Question_30,false)};
    @Override
