...
public class karmaveer extends AppCompatActivity {
    TextView qstn;
    TextView qun;
    TextView scr;
    ...
    QueAndAnsAdapter[] questionbank=new QueAndAnsAdapter[]{
            ...
            new QueAndAnsAdapter(R.string.Question_12,true),
            new QueAndAnsAdapter(R.string.Question_13,false),
            new QueAndAnsAdapter(R.string.Question_14,true),
            new QueAndAnsAdapter(R.string.Question_15,false),
